...
#' @usage data(crss)
#'
#' @format An object of class \code{data.table}. This is a table with "named" coordinate referenbce systems and their well-known-text (WKT2) representation. It can be used as-is, or with \code{\link{getCRS}}. The fields are as:
#' \itemize{
