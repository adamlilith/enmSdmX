...
#' # The "polygon" (imprecise) occurrences are simulated (not necessarily real).
#' 
...
#' polys <- mad1[mad1$NAME_2 %in% faritras, ]
#' 
#' mcpPolys <- mcpFromPointsPolys(polys = polys, terra = FALSE)
#' mcpPts <- mcpFromPointsPolys(pts = redBelly, polys = NULL, terra = FALSE)
#' mcpPolysPoints <- mcpFromPointsPolys(pts = redBelly, polys = polys,
#' terra = FALSE)
#' 
#' # extent of occurrence in m2
